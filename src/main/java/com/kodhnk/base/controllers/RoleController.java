...
public class RoleController {
    ...
    ResponseEntity<DataResult<Role>> addRoleToUser(@RequestParam Long roleId, @RequestParam Long userId) {
        DataResult<Role> result = roleService.addRoleToUser(roleId, userId);
        return ResponseEntity.status(result.getStatusCode()).body(result);
    }
